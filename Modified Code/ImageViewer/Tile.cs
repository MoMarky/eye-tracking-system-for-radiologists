...
using static ClearCanvas.Desktop.Application;
//using DesktopForm;
...
namespace ClearCanvas.ImageViewer
{
	...
	public class Tile : ITile
	{
        ...
        //###pricvate转public
		public IImageViewer _imageViewer;
        public ImageBox _parentImageBox;
        public PresentationImage _presentationImage;
        public RectangleF _normalizedRectangle;
        public Rectangle _clientRectangle;
        public bool _selected = false;
        public bool _enabled = true;
        public InformationBox _informationBox;
        public EditBox _editBox;
        public static int _borderWidth = 1;
        public static int _insetWidth = 5;
        public static Color _selectedColor = Color.Yellow;
        public static Color _unselectedColor = Color.Gray;
        public EventHandler<TileContextMenuRequestEventArgs> _contextMenuRequested;
        //###
		...
		/// been added to the <see cref="IImageBox"/> yet.</value>确定图片显示框的布局
		public IImageBox ParentImageBox
		{
			...
			internal set 
			{
                ...
                //_parentImageBox.ParentPhysicalWorkspace.ScreenRectangle.X
                //_parentImageBox.TopLeftPresentationImage.sp
		...
		public IPresentationImage PresentationImage
		{
			...
			internal set 
			{
				if (_presentationImage != value)
				{
                    ...
                    //this.ParentImageBox.TopLeftPresentationImage.ClientRectangle.Width;

                    //this.ParentImageBox.TopLeftPresentationImage.SceneSize;
                    //this.ParentImageBox.TopLeftPresentationImage.i
                    //_presentationImage.s
                    ...
                    //发送窗体坐标信息给desktopform.cs
                    //ClearCanvas.Desktop.Application app = new ClearCanvas.Desktop.Application();
                    //app["name"] = this.PresentationImage.ImageViewer.PhysicalWorkspace.ScreenRectangle.X;
                    //string s_url;
                    //s_url = "b.aspx?name=" + this.PresentationImage.ImageViewer.PhysicalWorkspace.ScreenRectangle.X.ToString();
                    //Response.Redirect(s_url);-		ClearCanvas.ImageViewer.StudyManagement.ISopProvider.Sop	{1 | 2.16.840.1.113662.2.12.0.3057.1241703565.44}	ClearCanvas.ImageViewer.StudyManagement.Sop {ClearCanvas.ImageViewer.StudyManagement.ImageSop}
                    //-		DataSource	{ClearCanvas.ImageViewer.StudyManagement.LocalSopDataSource}	ClearCanvas.ImageViewer.StudyManagement.ISopDataSource {ClearCanvas.ImageViewer.StudyManagement.LocalSopDataSource}



                    ///String presentFilename = "";// = _presentationImage.GetSop.Filename;
                    //Desktop.DesktopObject d;// OnToolbarParentChanged();
                    //ClearCanvas.Common.PublicMethod.SetPara(presentFilename);
                    ///ClearCanvas.Common.PublicMethod.GetPara(presentFilename);

                    //_parentImageBox.ParentPhysicalWorkspace.ImageBoxes.
                    ClearCanvas.Common.PublicMethod.SetPresentBoxContainer(
                        _parentImageBox.ParentPhysicalWorkspace.ScreenRectangle.X, 
                        _parentImageBox.ParentPhysicalWorkspace.ScreenRectangle.Y,
                        _parentImageBox.ParentPhysicalWorkspace.ScreenRectangle.Width,
                        _parentImageBox.ParentPhysicalWorkspace.ScreenRectangle.Height);

                    EventsHelper.Fire(_presentationImageChangedEvent, this, eventArgs);

                   // _parentImageBox.TopLeftPresentationImage
                }
			}
		}
